...
class UltimateTicTac extends StatefulWidget {
  const UltimateTicTac({Key? key}) : super(key: key);

  @override
  State<UltimateTicTac> createState() => _UltimateTicTacState();
}

class _UltimateTicTacState extends State<UltimateTicTac> {
